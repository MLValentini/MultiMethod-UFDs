...
Since the files used in the project (present in `Data/` directory) take up a lot of memory, the queries submitted to download the same files using the Gaia Archive (ADQL, [https://gea.esac.esa.int/archive/](https://gea.esac.esa.int/archive/)) are provided below:
